    ...
    <footer className="bg-black">
      <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
          ...
          <div>
            <p className="font-medium text-white">Reach Us</p>

            <ul className="mt-6 flex items-center justify-between gap-6 max-w-24 w-full">
              <li>
                <a
                  href="mailto:info@chromedoubleglazing.com"
                  rel="noreferrer"
                  target="_blank"
                  className="text-orange transition hover:opacity-75 block"
                >
