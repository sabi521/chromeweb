...
const Hero = () => {
  return (
    <section className="relative z-10 bg-[url(https://images.unsplash.com/photo-1604014237800-1c9102c219da?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1770&q=80)] bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative z-20 mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
        ...
        <div className="max-w-4xl text-left">
          ...
          <p className="mt-4 max-w-3xl text-orange sm:text-xl/relaxed">
          ...
          <div className="mt-8 text-center">
            <a
              href="#"
              className="block w-full max-w-60 rounded bg-rose-600 px-12 py-3 text-lg font-medium text-white shadow hover:bg-rose-700 focus:outline-none focus:ring active:bg-rose-500 sm:w-auto"
            >
              Learn More
            </a>
          </div>
